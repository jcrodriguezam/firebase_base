...
export const deleteDocument = (collection, id) => getRealTimeRef(`${collection}/${id}`).remove();

export const createDocument = (collection, id, values) => getRealTimeRef(`${collection}/${id}`).set(values);

export const updateDocument = (collection, id, values) => getRealTimeRef(`${collection}/${id}`).update(values);
